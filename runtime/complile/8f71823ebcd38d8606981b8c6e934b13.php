	    ...
	    <li  lay-id="t10">远程附件配置</li>
		  ...
		  <div class="layui-tab-content">
		  	   <div class="layui-tab-item layui-show">
					   ...
					   <div class="layui-form-item">
						   <label class="layui-form-label">是否使用Polyfill</label>
						   <div class="layui-input-block">
							   <input type="radio" name="use_polyfill" value="1" <?php if ($this->vars['configs']['use_polyfill']['value']==1) {?> checked="checked" <?php } ?> title="启用">
							   <input type="radio" name="use_polyfill" value="0" <?php if ($this->vars['configs']['use_polyfill']['value']==0) {?> checked="checked" <?php } ?> title="禁用">
							   <span class="layui-icon layui-icon-about tips" data-content="访问非主域名地址时自动跳转！"></span>
						   </div>
					   </div>
...
<?php return array (
  0 => 'D:/phpstudy_pro/WWW/www.testtt2.com/apps/admin/view/default/common/head.html',
  1 => 'D:/phpstudy_pro/WWW/www.testtt2.com/apps/admin/view/default/common/foot.html',
); ?>